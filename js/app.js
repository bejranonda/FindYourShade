...
const categories = {
    ...
    YELLOW: {
        id: 'YELLOW',
        name: 'เหลือง (อนุรักษ์นิยม)',
        icon: '🎗️',
        colorClass: 'bg-yellow-500',
        textClass: 'text-yellow-600',
        desc: 'คุณรักความสงบและเชิดชูสถาบันหลักของชาติ! ไม่ชอบความวุ่นวายหรือการลงถนนที่รุนแรง เชื่อในกฎระเบียบและครรลองคลองธรรม บางครั้งอาจดูเหมือนขวางโลกในสายตาเด็กๆ แต่คุณเชื่อว่า "ของเก่าก็มีดี" และการเปลี่ยนแปลงที่เร็วเกินไปอาจนำมาซึ่งหายนะ'
    },
    WHITE: {
        id: 'WHITE',
        name: 'ขาว (พลังเงียบ)',
...
const questions = [
    {
        ...
        choices: [
            ...
            { text: "ตักบาตร ฟังธรรม หรืออ่านข่าวพระราชสำนัก/ข่าวดีๆ ที่ไม่เครียด", score: { YELLOW: 3, WHITE: 1 } },
            { text: "รีบอาบน้ำแต่งตัวไปทำงาน รถติดชิบหาย การเมืองไม่ช่วยอะไรกูเลย", score: { WHITE: 3, BLUE: 1 } }
        ]
    },
    {
        ...
        choices: [
            ...
            { text: "โกรธมาก! พวกเด็กสมัยนี้ไม่รู้จักที่ต่ำที่สูง ต้องมีกฎหมายจัดการให้เข็ด", score: { YELLOW: 3 } },
    ...
    },
    {
        ...
        choices: [
            ...
            { text: "ใส่เสื้อเหลือง/ชมพู รอรับเสด็จ หรือไปร่วมงานบุญใหญ่ๆ แทน", score: { YELLOW: 3 } },
            { text: "นอนดูซีรีส์อยู่บ้าน ถ้าออกไปรถติด แย่เลย", score: { WHITE: 3 } }
        ]
    },
    {
        ...
        choices: [
            ...
            { text: "เพลงปลุกใจรักชาติ หรือเพลงพระราชนิพนธ์ ฟังแล้วอบอุ่นใจ", score: { YELLOW: 3 } },
    ...
    },
    {
        ...
        choices: [
            ...
            { text: "อันตราย! ล้มล้าง! เนรคุณแผ่นดิน! (รับไม่ได้อย่างแรง)", score: { YELLOW: 3 } },
            { text: "เฉยๆ นะ ถ้าเขาทำดีก็ดี ถ้าทำไม่ดีก็เลือกใหม่ (แต่ตอนนี้ขอทำงานก่อน)", score: { WHITE: 3, ORANGE: 1 } }
        ]
    },
    {
        ...
        choices: [
            ...
            { text: "สวดมนต์แผ่เมตตา หรือแชร์ธรรมะเตือนสติชาวเน็ต", score: { YELLOW: 3 } },
    ...
    },
    {
        ...
        choices: [
            ...
            { text: "ชาติ ศาสน์ กษัตริย์ มั่นคงยั่งยืนสถาพร ตลอดไป", score: { YELLOW: 3 } },
            { text: "มีความสุขกับชีวิตเรียบง่าย รวยๆ เฮงๆ สุขภาพแข็งแรง จบ", score: { WHITE: 3 } }
        ]
    }
];
...
function createConfetti() {
    const colors = ['#dc2626', '#f97316', '#3b82f6', '#a855f7', '#ec4899', '#f59e0b', '#eab308', '#9ca3af'];
...
function renderStartScreen() {
    ...
    scores = { NAM_MAK: 0, NOM_PHONG: 0, MADAM: 0, DARA: 0, ORANGE: 0, BLUE: 0, YELLOW: 0, WHITE: 0 };
    currentResult = null;
    ...
    contentDiv.innerHTML = `
        <div class="text-center w-full fade-in">
            ...
            <p class="text-gray-600 mb-8 px-4 leading-relaxed">
                ...
                หรือจริงๆ แล้วใจคุณ <span class="text-orange-500 font-bold">ส้ม</span>, <span class="text-blue-700 font-bold">น้ำเงิน</span>
                หรือ <span class="text-yellow-600 font-bold">เหลือง</span>?
            </p>
